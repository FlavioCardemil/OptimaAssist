...
export default function NavHeaderAsistenta({ nombre, email, label = "Asistenta" }: Props) {
      ...
      <div style={{ maxWidth: "1040px", margin: "0 auto", padding: "0 24px" }}>
        <div style={{ height: "56px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <p style={{ fontFamily: "var(--font-lora-var, serif)", fontSize: "15px", fontWeight: 700, color: "#FFFFFF", lineHeight: 1.1 }}>
                Óptima Assist
              </p>
              <p style={{ fontFamily: "var(--font-outfit-var, sans-serif)", fontSize: "10.5px", color: "rgba(255,255,255,0.55)", lineHeight: 1, marginTop: "2px", letterSpacing: "0.06em", textTransform: "uppercase" }}>
                {label}
              </p>
            </div>
          </div>
